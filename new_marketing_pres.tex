...
\begin{columns}
  ...
  \begin{column}{0.4\textwidth}
    ...
    \smartdiagramset{font=\small}
    \scalebox{0.6}{\smartdiagram[bubble diagram]{AFRL Morph X,
        Design, Repair, Operation, Manufacture}}
...
\begin{center}
    \begin{tikzpicture}
      ...
      \node (img1) [label={[align=center, below, xshift=-1.25cm, yshift=-4.5cm]FEM\\Side View}, inner sep=0][xshift=-3cm]{\includegraphics[height=4.5cm, trim={14cm, 0cm, 0cm, 0cm}, clip]{./figures/disk_side.png}};
      \node (img2) at (img1.east)[label={[align=center, below, xshift=-0.5cm, yshift=-4.5cm]Target CAD\\Side View}, inner sep=0][yshift=0.0cm]{\includegraphics[height=4.5cm, trim={7cm, 0cm, 0cm, 0cm}, clip]{./figures/disk2_side.png}};
      \node (img3) at (img2.east)[label={[align=center, below, xshift=-0.5cm,yshift=-4.75cm]FEM\\Front View}, inner sep=0][xshift=1.0cm, yshift=0.0cm]{\includegraphics[height=4.9cm, trim={13.0cm, 0cm, 3cm, 1cm}, clip]{./figures/disk_front.png}};
      \node (img4) at (img3.east)[label={[align=center, below, yshift=-4.75cm]Target CAD\\Front View}, inner sep=0][xshift=0.25cm]{\includegraphics[height=4.9cm, trim={13cm, 0cm, 9cm, 1cm}, clip]{./figures/disk2_front.png}};
    \end{tikzpicture}
\end{center}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \node (img5) at (img4.south east) [xshift=1.0cm]{\includegraphics[height=3.0cm]{./figures/disk_front_2.png}};
...
\begin{frame}
  ...
  %% \tikzstyle{block} = [rectangle, draw, fill=white!20, 
  %%   text width=4em, text centered, rounded corners, minim height=1.1cm]
  ...
  \begin{tikzpicture}
    ...
    \draw [->] [color=blue, line width=0.45mm] (0.0, -0.75) -- (2.0, -0.75);
    
    
    \node [block, right of=circle, xshift=1.8cm, yshift=0.8cm] (block1) {\includegraphics[height=1.0cm, , trim={13cm, 7cm, 13cm, 1cm}, clip]{./figures/pbs4_blend_1.png}};
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \node (img2) at (img1.south) [label={[align=center, below, yshift=-2.5cm]Design FEM}, yshift=-2.5cm, inner sep=-2pt]{\includegraphics[height=2.5cm]{./figures/pbs_fem.png}};
    \node (circle) [circle] at (img1.south east) [align=center, yshift=-0.75cm, xshift=1.5cm, color=white, fill=blue, inner sep=8pt]{AFRL\\ MORPH X};
    ...
    \draw[->,thick] (img1.east) -- (circle.west);
    \draw[->,thick] (img2.east) -- (circle.west);
...
\frame{
  ...
  \item Rigourous software development practices have enabled rapid development and succesful deployment 
  \item Used pervasively on AFRL Turbine Engine Divsion Research, product development, and field support
  \item Used extensivey by P\&W in many applications
