...
\begin{frame}
  ...
  \framesubtitle{Integrating with Maintenance, Repair, and Operations with FEMORPH}
    \begin{tikzpicture}
      ...
      \node (img2) at (img0.south) [label={[align=center, above, yshift=-3.0cm] Assess Damage}, yshift=-2.0cm, inner sep=-2pt]{\includegraphics[trim={0.0cm 12.0cm 15.0cm 0.0cm}, clip, height=2.5cm]{./figures/mrb_pic.png}};
      ...
      \node [] at (-1.35, -6.6) {\tiny Airfoil Edge};
      \node [] at (-1.225, -6.8) {\tiny Damage};
      %%\draw [->] (2.5, -0.75) -- (4.5, -0.75);
...
%-------------------------------------------------------------------------------------------------------#
 \begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \node (img1) at (img0.east) [label={[align=center, below, xshift=0.0cm, yshift=-2.7cm]Improved Instrumentation}, yshift=-0.05cm, xshift=3.5cm, inner sep=0pt]{\includegraphics[height=2.5cm]{./figures/strain_gage.png}};
    ...
    \node (img3) at (img2.east) [label={[align=center, below, yshift=-2.7cm]Adaptive Toolpath Generation}, xshift=3.5cm, yshift=-0.2cm, inner sep=-2pt]{\includegraphics[trim={0cm 0 0.0cm 0}, clip, height=2.75cm]{./figures/blade_optomec_xsec.png}};
  \end{tikzpicture}
