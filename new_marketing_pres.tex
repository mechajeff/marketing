...
\title{\vspace{3mm} \textbf{FEMORPH}}
\subtitle{Target Surface Computational Mesh Morphing}

\author{\vspace{-2mm}\large {Jeff Brown\\
  Alex Kaszynski}}
...
\institute{Engine Integrity Branch\\
  ...
  Aerospace Systems Directorate}
    \date{\today}
    %\distribution{\color{black} \small{\textbf{Distribution Statemeent A: Approved for public release:  distribution unlimited.  Case No. AFRL-2021-1006}}}
    \distribution{\color{white} \small{\textbf{Distribution Statemeent A: Approved for public release:  distribution unlimited.  Case No. AFRL-2021-1006}}}
    ...
    %\distribution{\textbf{DISTRIBUTION STATEMENT C.} / Distribution authorized to U.S. Government Agencies and their contractors () (Feb. 2021).  Other requests for this document shall be referred to AFRL/RQTI, 1950 Fifth Street, WPAFB, OH}
\conference{}
\begin{document}
...
%-------------------------------------------------------------------------------------------------------#
\frame{
  \frametitle{AFRL FEMORPH}
  \framesubtitle{3D Mesh Morphing Software - FEM, CFD, .STL, CMM data, ...}
  \vspace{-5mm}
  ...
  \begin{columns}
    ...
    \begin{column}{0.60\textwidth}    
      \begin{itemize}
        ...
        \item Simplify 2D and 3D shape opimizaion
        \item Robustly generate computer experiment designs
        \item Save design time by removing mesh generation bottlenecks
        \item Assess impacts of as-manufactured geometry on design intent
        \item Learn the effects of operational damage on continued use
    ...
    \begin{column}{0.40\textwidth}
      ...
      \scalebox{0.50}{\smartdiagram[bubble diagram]{\includegraphics[height=2.25cm]{./figures/morph_logo.png} \\\Large AFRL\\\Large FEMOPRH,
          \Large Design, \Large Repair, \Large Operation, \Large Manufacture}}
    \end{column}
...
\begin{frame}
  ...
  \framesubtitle{Morph FEM to Parameterized CAD Model}
  \vspace{-0mm}
  %\begin{center}
    \begin{tikzpicture}
      %\node (img1) {\includegraphics[height=4.5cm, trim={14cm, 0cm, 0cm, 0cm}, clip]{./figures/diskfem_side.png}};      
      \node (img1) [xshift=2.0cm]{\includegraphics[height=3.0cm, trim={0cm, 0cm, 0cm, 0cm}, clip]{./figures/disk1_xsec.jpg}};
      \node (img2) at (img1.east) [xshift=1.30cm]{\includegraphics[height=3.0cm, trim={7cm, 0cm, 0cm, 0cm}, clip]{./figures/diskcad_side.png}};

      \node [draw] at (img2.east) (logo) [xshift=0.75cm]{\includegraphics[height=1.75cm]{./figures/morph_logo.png}};
      
      \node (img5) at (logo.east) [xshift=3.0cm]{\includegraphics[height=3.0cm, trim={14cm, 0cm, 0cm, 0cm}, clip]{./figures/diskfem_side.png}};
      \node (img3) at (img5.south) [xshift=-0.5cm, yshift=-1.5cm]{\includegraphics[height=3.0cm, trim={13.0cm, 0cm, 3cm, 1cm}, clip]{./figures/diskfem_front.png}};
      
      \node (img3) at (img1.south)[yshift=-1.5cm]{\includegraphics[height=3.0cm, trim={0cm, 0cm, 0cm, 0cm}, clip]{./figures/disk1_front.jpg}};
      \node (img4) at (img3.east) [xshift=1.0cm]{\includegraphics[height=3.5cm, trim={13cm, 0cm, 9cm, 1cm}, clip]{./figures/diskcad_front.png}};

      \node (img4) at (logo.south) [yshift=-2.15cm]{\includegraphics[height=3.5cm, trim={13cm, 0cm, 9cm, 1cm}, clip]{./figures/disk_front_morphed.png}};

      \node [] at (3.0, -5.0) (cap1) [align=center]{Parameterized CAD};
      \node [] at (10.25, -5.0) (cap1) [align=center]{Initial FEM};

      \draw [dotted] (1, 1.5) rectangle (5.4, -4.5);
      \draw [dotted] (9.35, 1.5) rectangle (11.1, -4.5);
      %\node (box1) at (1, 1.5) [draw,dotted,minimum width=4.5cm,minimum height=6.0cm] {};

      \draw [->] [color=black, line width=0.45mm] (5.4, -1.5) -- (logo.west);
      \draw [->] [color=black, line width=0.45mm] (9.35, -1.5) -- (logo.east);
      \draw [->] [color=black, line width=0.45mm] (logo.south) -- (7.08, -1.65);

      \node [] at (logo.north) (caption) [align=center, yshift=0.25cm]{AFRL FEMORPH};
      \node [] at (img4.south) (caption) [align=center, yshift=0.0cm]{Morphed FEM};
...
%% \begin{frame}
%%   \frametitle{Design with AFRL FEMORPH}
%%   \framesubtitle{Morph FEM to Parametrically Variable CAD Surface}
%%   \begin{center}
...
\begin{frame}
  \frametitle{Design with AFRL FEMORPH}
  \framesubtitle{Morphing FEM to CAD}
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \node (img1) [label=below:0\% Morph] {\includegraphics[height=3.0cm]{./figures/disk_side_1.png}};
      \node (img2) at (img1.south east) [label=below:50\% Morph][xshift=1.0cm]{\includegraphics[height=3.0cm]{./figures/disk_side_2.png}};
      \node (img3) at (img2.south east) [label=below:100\% Morph][xshift=1.0cm]{\includegraphics[height=3.0cm]{./figures/disk_side_3.png}};

      \node (img4) at (img1.east) [xshift=4.0cm]{\includegraphics[height=3.0cm]{./figures/disk_front_1.png}};
      \node (img5) at (img4.south east) [label=below:50\% Morph][xshift=1.0cm, yshift=0.1cm]{\includegraphics[height=3.0cm]{./figures/disk_front_2.png}};
      \node (img6) at (img5.south east) [label=below:100\% Morph][xshift=1.0cm]{\includegraphics[height=3.0cm]{./figures/disk_front_3.png}};

      %\draw [->, blue, ultra thick] (-0.5, -2.5) -- (2.25, -4.75);
      \draw[-latex, blue!50, line width=2mm] (-0.5, -2.5) -- (2.25, -4.75);
      \draw [-latex, blue!50, line width=2mm] (7.0, 1.5) -- (10.0, -1.0);
...
%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Animation - Click image to Play (disk\_side.mp4)}
...
%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Animation - Click image to Play (disk\_front.mp4)} 
  %%\framesubtitle{Morph Simple Plate FEM to Complex 3D Turbine Airfoil Surface}
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \node [] at (0.15, -2.25) (caption) [align=center]{AFRL\\FEMORPH};%{\includegraphics{./figures/morph_logo.png}};
...
%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Animation - Click image to Play (blade\_plate.mp4)}
  %%\framesubtitle{Morph Simple Plate FEM to Complex 3D Turbine Airfoil Surface}

  \begin{figure}
    \centering    
    \movie[label=show3, width=1.0\textwidth, poster, autostart, showcontrols, loop]{\includegraphics[width=1.0\textwidth]{./figures/jetcat_vidcover.png}}{./figures/blade_plate.mp4}
 \end{figure} 
\end{frame}

%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Manufacturing with AFRL FEMORPH}
...
\begin{frame}
  \frametitle{Manufacturing with AFRL FEMORPH}
  \framesubtitle{AFRL FEMORPH updates the Design FEM to match the STL surface within 0.001''}
  \begin{tikzpicture}
...
%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Animation - Click image to Play (blade\_morphvid.mp4)}
  %%\framesubtitle{Morph Simple Plate FEM to Complex 3D Turbine Airfoil Surface}

  \begin{figure}
    \centering    
    \movie[label=show3, width=1.0\textwidth, poster, autostart, showcontrols, loop]{\includegraphics[width=1.0\textwidth]{./figures/pbs_vidcover.png}}{./figures/pbs_morphvid.mp4}
 \end{figure} 
\end{frame}

%-------------------------------------------------------------------------------------------------------#
\begin{frame}
  \frametitle{Operations with AFRL FEMORPH}
  \framesubtitle{Integrating with Maintenance, Repair, and Operations with FEMORPH}
    \begin{tikzpicture}
      ...
      %\node (img2) at (img0.south) [label={[align=center, above, yshift=-3.0cm] Assess Damage}, yshift=-2.0cm, inner sep=-2pt]{\includegraphics[trim={2.5cm 15.0cm 15.0cm 0.0cm}, clip, height=2.5cm, width=2.5cm]{./figures/mrb_pic.png}};
      \node (img2) at (img0.south) [label={[align=center, above, yshift=-3.0cm] Assess Damage}, yshift=-2.0cm, inner sep=-2pt]{\includegraphics[ height=2.5cm]{./figures/turbine_edge_damage.jpg}};
      %\node (img3) at (img1.south) [label={[align=center, above, yshift=-3.0cm] Safety Review  Board}, yshift=-2.4cm, inner sep=-2pt]{\includegraphics[trim={2.0cm 1.1cm 1.0cm 0.0cm}, clip, height=2.5cm]{./figures/safety_pic.png}};
      \node (img3) at (img1.south) [label={[align=center, above, yshift=-3.0cm] Safety Review  Board}, yshift=-2.4cm, inner sep=-2pt]{\includegraphics[trim={3.6cm 1.7cm 0cm 1.0cm}, clip, height=2.5cm]{./figures/msac_scatter_m0.pdf}};
      %\node [] at (6.0, -8.0) {\tiny Outlier Part Behavior};

      %\node [] at (-1.65, -6.6) {\tiny Airfoil Edge};
      %\node [] at (-1.525, -6.8) {\tiny Damage};
      %%\draw [->] (2.5, -0.75) -- (4.5, -0.75);

      \node [] at (4.5, -6.0) {\tiny Outlier};
...
\begin{frame}
  \frametitle{More with AFRL FEMORPH}
  \framesubtitle{}

  \begin{tikzpicture}
    \node (img0) at (0, 0) [yshift=-3.5cm, xshift=0.0cm, inner sep=0pt]{\includegraphics[height=2.0cm]{./figures/hptmoviecrop.png}};
    \node (img1) at (img0.south east) [label={[align=center, above, xshift=-0.75cm, yshift=-2.5cm]Turbine CFD Mesh Morphing}, yshift=-0.0cm, xshift=0.1cm, inner sep=0pt]{\includegraphics[height=2.0cm]{./figures/EfficiencyHistogram.pdf}};
...
%-------------------------------------------------------------------------------------------------------#
 \begin{frame}
  \frametitle{Even more with AFRL FEMORPH}
  \framesubtitle{}
  \vspace{-5mm}
  \begin{tikzpicture}
    \node (img0) at (0, 0) [label={[align=center, below, xshift=-0.0cm, yshift=-3.0cm]CMM Data Capable}, yshift=-3.0cm, xshift=0.0cm, inner sep=0pt]{\includegraphics[height=3.0cm]{./figures/cmm_points.png}};
    \node (img1) at (img0.east) [label={[align=center, below, xshift=0.0cm, yshift=-2.7cm]Improved Gage Limits}, yshift=-0.05cm, xshift=3.5cm, inner sep=0pt]{\includegraphics[height=2.5cm]{./figures/strain_gage.png}};
    \node (img2) at (img0.south) [label={[align=center, below, yshift=-2.8cm]Improved Model Validation}, yshift=-2.2cm, xshift=0.0cm, inner sep=-2pt]{\includegraphics[trim={0.0cm 0 0.0cm 0}, clip, height=2.75cm]{./figures/pbs_rig.png}};
    %\node (img3) at (img2.east) [label={[align=center, below, yshift=-2.7cm]Adaptive Toolpath Generation}, xshift=3.5cm, yshift=-0.2cm, inner sep=-2pt]{\includegraphics[trim={0cm 0 0.0cm 0}, clip, height=2.75cm, width=4.5cm]{./figures/blade_optomec_xsec.png}};
    \node (img3) at (img2.east) [label={[align=center, below, yshift=-2.8cm]Adaptive Toolpath Generation}, xshift=3.7cm, yshift=-0.05cm, inner sep=-2pt]{\includegraphics[trim={0cm 0 0.0cm 1.0cm}, clip, height=2.75cm]{./figures/ibr_milling.jpg}};
  \end{tikzpicture}
...
\frame{
  ...
  \vspace{-6mm}
  \begin{itemize}
  \item AFRL FEMORPH adds value across the life cycle, from design, to manufacture, and through operations
  ...
  \begin{center}
  \smartdiagramset{font=\small}
  \scalebox{0.45}{\smartdiagram[bubble diagram]{\includegraphics[height=2.25cm]{./figures/morph_logo.png} \\\Large AFRL\\ \Large FEMORPH,
      \Large Design, \Large Repair, \Large Operation, \Large Manufacture}}
  \end{center}
